    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 text-xs font-semibold text-slate-500">
          ...
          <span>/</span>
          <span className="text-slate-400">Guides & Updates</span>
          <span>/</span>
        ...
        <header className="mt-6 border-b border-slate-200 pb-8">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-4 text-xs text-slate-500">
            ...
            <div className="flex items-center gap-1.5 text-emerald-700 font-semibold">
              ...
              <span>Verified Admissions Research</span>
            </div>
          </div>
        </header>
        ...
        <article className="prose prose-slate mt-8 max-w-none">
          ...
          {article.author && (
            <div className="mt-10 flex items-center gap-4 rounded-2xl border border-slate-200 bg-slate-50/80 p-5 not-prose">
              ...
              <div>
                <span className="text-[10px] font-bold uppercase tracking-wider text-[#EA5C2B]">Article Author & Strategist</span>
