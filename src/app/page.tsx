...
const FALLBACK_ARTICLES: ArticlePreview[] = [
  { _id: "fb-1", title: "Germany Ausbildung 2027: Complete Dual Vocational Guide for Indian Students", slug: "germany-ausbildung-2027-guide", tag: "Germany • Vocational", readTime: "6 min read", excerpt: "How to secure €1,100/month monthly stipend with 0 tuition in German hospitals and tech firms.", date: "Sep 2026" },
  { _id: "fb-2", title: "NMC Foreign Medical Graduate Regulations: Essential Checklist for MBBS Abroad", slug: "nmc-fmgl-regulations-mbbs-abroad-checklist", tag: "Medical • NMC Guidelines", readTime: "8 min read", excerpt: "54-month course duration, 12-month internship, and CRMI clinical guidelines you must know before applying.", date: "Sep 2026" },
  { _id: "fb-3", title: "UK Graduate Route vs Canada PGWP: Work Visa Rights Comparison in 2026-2027", slug: "uk-graduate-route-vs-canada-pgwp-comparison", tag: "Visa • Immigration", readTime: "5 min read", excerpt: "An in-depth breakdown of current visa tenure, PR eligibility, and post-study employment trends.", date: "Aug 2026" },
  { _id: "fb-4", title: "How to Build a High-Probability SOP for Top US & German Universities", slug: "how-to-write-winning-sop-us-germany", tag: "Admissions • Prep", readTime: "7 min read", excerpt: "The 5 critical elements admissions committees evaluate in Indian engineering and MBA applicants.", date: "Aug 2026" },
];
    ...
    <HomeModalProvider>
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <main>
          ...
          {/* Featured Universities Section - Server Rendered HTML */}
              ...
              <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                <div className="lg:col-span-6">
                  ...
                  <div className="mt-8 flex flex-wrap items-center gap-4">
                    <AICounsellorTriggerButton
                      className="inline-flex items-center gap-2 rounded-xl bg-[#EA5C2B] px-6 py-3.5 text-xs font-bold text-white shadow-xl transition hover:bg-[#ff7240] hover:scale-102"
                    >
                  ...
                  <div className="rounded-3xl border border-white/20 bg-[#132c52] sm:bg-white/10 p-5 shadow-2xl sm:backdrop-blur-xl sm:p-7">
                    <div className="flex items-center justify-between border-b border-white/10 pb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-xs font-bold text-white">Vista AI Admissions Assistant</p>
                          <span className="text-[10px] text-emerald-400 font-medium flex items-center gap-1">
                            <span className="h-1.5 w-1.5 rounded-full bg-emerald-400"></span> Online & Ready
                          </span>
                        </div>
                      </div>
              ...
              <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-lg transition group">
                  <div>
                    ...
                    <p className="mt-2 text-xs text-slate-500 leading-relaxed">
                      Estimate tuition fees, monthly living costs, blocked accounts, and part-time earnings offsets across 19 countries in ₹ Lakhs.
                    </p>
                  </div>
                  <Link
                    href="/cost-calculator"
                ...
                <div className="flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-lg transition group">
                  <div>
                    ...
                    <p className="mt-2 text-xs text-slate-500 leading-relaxed">
                      Model 5-year career payback timelines, pre- vs post-degree salary bumps, and tax-adjusted take-home earnings across Tier 1 countries.
                    </p>
                  </div>
                  <LeadTriggerButton
                    className="mt-5 inline-flex items-center gap-1.5 text-xs font-bold text-[#EA5C2B] group-hover:translate-x-0.5 transition text-left"
                ...
                <div className="flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-lg transition group">
                  <div>
                    ...
                    <p className="mt-2 text-xs text-slate-500 leading-relaxed">
                      Check admission readiness: match your 10th, 12th, undergraduate GPA, and IELTS/GRE test scores with realistic university brackets.
                    </p>
                  </div>
                  <LeadTriggerButton
                    className="mt-5 inline-flex items-center gap-1.5 text-xs font-bold text-[#EA5C2B] group-hover:translate-x-0.5 transition text-left"
                ...
                <div className="flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-lg transition group">
                  <div>
                    ...
                    <p className="mt-2 text-xs text-slate-500 leading-relaxed">
                      Explore collateral and non-collateral education financing, interest rate comparisons, and loan sanctions with top Indian banking partners.
                    </p>
                  </div>
                  <LeadTriggerButton
                    className="mt-5 inline-flex items-center gap-1.5 text-xs font-bold text-[#EA5C2B] group-hover:translate-x-0.5 transition text-left"
                ...
                <div className="flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-lg transition group">
                  <div>
                    ...
                    <p className="mt-2 text-xs text-slate-500 leading-relaxed">
                      Track critical 2027 intake cutoffs, scholarship deadlines, and visa processing windows personalized to your target destinations.
                    </p>
                  </div>
                  <LeadTriggerButton
                    className="mt-5 inline-flex items-center gap-1.5 text-xs font-bold text-[#EA5C2B] group-hover:translate-x-0.5 transition text-left"
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-end">
                <div>
                  ...
                  <p className="mt-2 text-sm text-slate-600">
                    Authoritative, constantly updated research compiled by admissions strategists at Dnyanal Educon.
                  </p>
                </div>
                <Link
                  href="/articles"
                  ...
                  >
                    <div>
                      <div className="flex items-center justify-between text-[11px] text-slate-500">
                        <span className="font-bold text-[#EA5C2B]">{article.tag}</span>
            ...
            <div className="mx-auto max-w-4xl px-4">
              ...
              <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-3 text-left">
                <div className="rounded-2xl bg-white p-5 shadow-xs border border-slate-200">
                  ...
                  <h3 className="font-bold text-xs text-[#102C57]">Zero Hidden Charges</h3>
                  <p className="mt-1 text-[11px] text-slate-500">
                    Open access to real tuition fee structures, official visa rules, and living expense estimates.
                  </p>
                </div>

                <div className="rounded-2xl bg-white p-5 shadow-xs border border-slate-200">
                  <ShieldCheck className="h-6 w-6 text-[#102C57] mb-2" />
                  <h3 className="font-bold text-xs text-[#102C57]">NMC & Accreditation Safe</h3>
                  <p className="mt-1 text-[11px] text-slate-500">
                    Every medical university is verified against National Medical Commission & WHO licensing standards.
                  </p>
                </div>

                <div className="rounded-2xl bg-white p-5 shadow-xs border border-slate-200">
                  <Sparkles className="h-6 w-6 text-[#EA5C2B] mb-2" />
                  <h3 className="font-bold text-xs text-[#102C57]">24/7 AI Smart Advisor</h3>
                  <p className="mt-1 text-[11px] text-slate-500">
                    Get personalized recommendations, fee calculations, and deadline reminders anytime on WhatsApp or web.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
              <div className="rounded-3xl bg-gradient-to-r from-[#102C57] via-[#123b5d] to-[#091A36] p-8 sm:p-12 text-white shadow-xl relative overflow-hidden">
                ...
                <p className="mt-4 font-serif text-xl sm:text-2xl leading-relaxed text-slate-100">
                  “The shortlist and cost comparison helped our family understand the realistic total expenses in ₹ Lakhs before we ever committed to speaking with a counsellor.”
                </p>
                <div className="mt-6 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-300">MS in Computer Science · Admitted to TU Munich</p>
                  </div>
                </div>
              </div>
            </div>
