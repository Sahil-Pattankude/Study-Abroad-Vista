        ...
        <div className="w-full max-w-md rounded-3xl border border-red-900/40 bg-slate-900/80 p-8 shadow-2xl backdrop-blur-xl text-center">
          ...
          <div className="mt-6 flex flex-col gap-3">
            <Link
              ...
              className="flex items-center justify-center gap-2 rounded-xl bg-[#EA5C2B] py-3 text-xs font-bold text-white shadow-lg transition hover:bg-[#d94f20] active:scale-[0.99]"
            >
            ...
            <Link
              href="/"
              className="rounded-xl border border-slate-800 bg-slate-900/60 py-2.5 text-xs font-semibold text-slate-400 hover:text-slate-200 hover:bg-slate-800"
            >
        ...
        <div className="w-full max-w-md rounded-3xl border border-amber-900/40 bg-slate-900/80 p-8 shadow-2xl backdrop-blur-xl text-center">
          ...
          <div className="mt-6 flex flex-col gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 rounded-xl bg-[#EA5C2B] py-3 text-xs font-bold text-white shadow-lg transition hover:bg-[#d94f20]"
            >
              <LogOut className="h-3.5 w-3.5" />
              <span>Switch / Sign In with Admin Account</span>
            </button>
            ...
            <Link
              ...
              className="rounded-xl border border-slate-800 bg-slate-900/60 py-2.5 text-xs font-semibold text-slate-300 hover:text-white hover:bg-slate-800"
            >
